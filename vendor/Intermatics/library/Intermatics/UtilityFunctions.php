...
class UtilityFunctions
{
    ...
    static public function sendMail($to,$title,$message){

    }

    static public function  getObjectProperties($object)
    {
    ...
    static function boolToString($bool)
    {
    	$return = 'Yes';
    	if (empty($bool)) {
    		$return = 'No';
