...
class AddDownloadPermissions extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $data = [
            ...
            [
                'permission'=>'edit_download',
                'path'=>'download/edit',
                'permission_group_id'=>13
            ],
            [
                'permission'=>'add_download',
                'path'=>'download/add',
                'permission_group_id'=>13
            ],
            [
                'permission'=>'delete_download',
        ...
        $rowset = $this->query("SELECT * FROM permission where permission_group_id=13");
